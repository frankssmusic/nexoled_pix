...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .bokeh-bg {
    ...
    background: radial-gradient(ellipse at 20% 50%, #0a0520 0%, #060810 60%);
  }
  .bokeh-bg::before {
    content: '';
    position: absolute; inset: 0;
    background:
      radial-gradient(circle at 15% 25%, #ff00aa22 0%, transparent 35%),
      radial-gradient(circle at 85% 15%, #00f5ff18 0%, transparent 30%),
      radial-gradient(circle at 70% 80%, #ff00aa15 0%, transparent 40%),
      radial-gradient(circle at 30% 75%, #00f5ff12 0%, transparent 35%);
  }
  .bokeh-orb {
    position: absolute; border-radius: 50%;
    filter: blur(60px); animation: floatOrb linear infinite;
  }
  ...
  @keyframes floatOrb {
    ...
    33% { transform: translateY(-30px) scale(1.05); opacity: 0.8; }
    66% { transform: translateY(15px) scale(0.95); opacity: 0.5; }
  ...
  @keyframes ledGlow {
    0%,100%{box-shadow: 0 0 10px #00f5ff, 0 0 25px #00f5ff44, inset 0 0 15px #00f5ff11;}
    50%{box-shadow: 0 0 5px #00f5ff, 0 0 12px #00f5ff22, inset 0 0 8px #00f5ff08;}
  }
  @keyframes logoGlow {
    0%,100%{filter: drop-shadow(0 0 8px #00f5ff66);}
    50%{filter: drop-shadow(0 0 16px #00f5ffaa);}
  }
  ...
  .logo-main {
    ...
    background: linear-gradient(135deg, #60ffff 0%, #00f5ff 40%, #ff00aa 100%);
  ...
  .logo-pix {
    ...
    color: #ff00aa; letter-spacing: 6px; font-size: 10px;
    text-transform: uppercase; margin-top: -2px;
  }

  .nav-bar {
    display: flex; gap: 4px; padding: 10px 16px;
    background: #0d0f1aee; backdrop-filter: blur(20px);
  ...
  .nav-btn {
    ...
    border: 1px solid #1a1d35; background: transparent;
    color: #5a5f85; cursor: pointer;
  ...
  .pending-badge {
    margin-left: auto; font-size: 10px; color: #ff9900;
    font-family: 'Orbitron'; letter-spacing: 1px;
    background: #ff990015; border: 1px solid #ff990033;
  ...
  .btn-cyan { background: linear-gradient(135deg, #00f5ff 0%, #0099bb 100%); color: #000; box-shadow: 0 4px 20px #00f5ff44; }
  .btn-cyan:hover { transform: translateY(-2px); box-shadow: 0 8px 30px #00f5ff66; }
  .btn-magenta { background: linear-gradient(135deg, #ff00aa 0%, #aa0066 100%); color: #fff; box-shadow: 0 4px 20px #ff00aa44; }
  ...
  .input {
    ...
    border: 1px solid #1a1d35; background: #060810;
    color: #e8eaf6; font-family: 'Inter'; font-size: 14px;
  ...
  .tag {
    ...
    font-size: 9px; font-family: 'Orbitron'; font-weight: 700;
    background: #00f5ff18; color: #00f5ff;
    border: 1px solid #00f5ff33; margin-bottom: 10px; letter-spacing: 2px;
  }
  ...
  /* TOTEM LED */
  .totem-wrap { display: flex; flex-direction: column; align-items: center; gap: 12px; margin: 8px 0; }

  .totem-screen {
    position: relative; width: 100%; max-width: 320px;
    aspect-ratio: 2.5 / 1;
    border-radius: 8px; overflow: hidden; cursor: pointer;
    border: 2px solid #00f5ff66;
  ...
  .totem-inner {
    ...
    background: linear-gradient(135deg, #080c20 0%, #0d1030 100%);
    gap: 6px;
  }
  .totem-icon { font-size: 26px; filter: drop-shadow(0 0 8px #00f5ff); }
  .totem-text { font-family: 'Rajdhani'; font-weight: 700; font-size: 13px; color: #00f5ff; letter-spacing: 2px; text-transform: uppercase; }
  .totem-sub { font-size: 10px; color: #5a5f85; font-family: 'Inter'; }
  .totem-screen::before, .totem-screen::after {
    content: ''; position: absolute; width: 5px; height: 5px;
    border-radius: 50%; background: #00f5ff;
    box-shadow: 0 0 6px #00f5ff; z-index: 3;
  }
  .totem-screen::before { top: 5px; left: 5px; }
  .totem-screen::after { top: 5px; right: 5px; }

  .totem-screen-2 {
    width: 65%; max-width: 210px; aspect-ratio: 2.5 / 1;
    border-radius: 6px; border: 1px solid #ff00aa33;
    box-shadow: 0 0 10px #ff00aa22;
    background: linear-gradient(135deg, #150820, #1a0d28);
    display: flex; align-items: center; justify-content: center; opacity: 0.5;
  }
  .totem-screen-2-text { font-family: 'Orbitron'; font-size: 8px; color: #ff00aa88; letter-spacing: 2px; }
  ...
  .photo-time { font-size: 10px; color: #5a5f85; font-family: 'Orbitron'; letter-spacing: 1px; }
  ...
  .toast {
    ...
    background: #131628; border: 1px solid #00f5ff66;
    color: #e8eaf6; padding: 12px 24px; border-radius: 10px;
    font-size: 13px; z-index: 999; animation: fadeInUp 0.3s ease;
    box-shadow: 0 8px 30px #00f5ff18; white-space: nowrap;
    font-family: 'Rajdhani'; font-weight: 600; letter-spacing: 0.5px;
  }
  ...
  .evento-nombre {
    font-family: 'Orbitron'; font-weight: 700; font-size: 18px;
    background: linear-gradient(135deg, #60ffff, #ff60cc);
  ...
  @media (max-width: 480px) {
    ...
    .evento-nombre { font-size: 15px; }
    .totem-screen { max-width: 280px; }
    ...
    <div className="bokeh-bg">
      {orbs.map((o, i) => (
        <div key={i} className="bokeh-orb" style={{
          ...
          animationDuration: o.dur, animationDelay: `${i * 1.5}s`
        }} />
      ))}
    </div>
  );
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", padding: "0 16px 40px" }}>
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginTop: 24, color: "#5a5f85", fontSize: 10, fontFamily: "Orbitron", letterSpacing: 2 }}>
          POWERED BY NEXOLED · PUNTA ARENAS
        </div>
      </div>
    </div>
  );
    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 360, animation: "fadeInUp 0.4s ease" }}>
        <div className="card">
          ...
          {error && <div style={{ color: "#ff3355", fontSize: 12, marginBottom: 12, fontFamily: "Rajdhani" }}>{error}</div>}
    ...
    <div style={{ padding: "18px 16px", maxWidth: 900, margin: "0 auto" }}>
      ...
      {visible.length === 0 ? (
        ...
        <div className="photo-grid">
          {visible.map(photo => (
            <div key={photo.id} className={`photo-card ${selected.includes(photo.id) ? "selected" : ""}`}
    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 360, animation: "fadeInUp 0.4s ease" }}>
        <div className="card">
          ...
          <input className="input" type="password" placeholder="Clave admin" value={pass} onChange={e => setPass(e.target.value)}
            onKeyDown={e => e.key === "Enter" && (pass === ADMIN_PASSWORD ? (setLoggedIn(true), setError("")) : setError("Clave incorrecta"))}
    ...
    <div style={{ padding: "18px 16px", maxWidth: 640, margin: "0 auto" }}>
      ...
      <div className="card" style={{ marginBottom: 14 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div><label style={{ fontSize: 11, color: "#5a5f85", display: "block", marginBottom: 6, fontFamily: "Orbitron", letterSpacing: 1 }}>Nombre del evento</label>
            <input className="input" value={eventName} onChange={e => setEventName(e.target.value)} placeholder="Ej: Boda de Javier y Paola" /></div>
          <div><label style={{ fontSize: 11, color: "#5a5f85", display: "block", marginBottom: 6, fontFamily: "Orbitron", letterSpacing: 1 }}>Clave del operador</label>
